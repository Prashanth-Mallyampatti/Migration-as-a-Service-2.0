...
MIG_LOG = "/root/Migration-as-a-Service-2.0/var/logs/migration.log"
...
notifier_mig.add_watch('/root/Migration-as-a-Service-2.0/src/northbound/config_files/migration')
...
for event in notifier_mig.event_gen():
    if event is not None:
        ...
        if 'IN_CREATE' in event[1]:
             ...
             yaml_file = "/root/Migration-as-a-Service-2.0/src/northbound/config_files/migration/" + str(tenant)
             ...
             # Set 1 in is_migration_in_progress file so that self healing 
             # does not implement and affect migration tasks
